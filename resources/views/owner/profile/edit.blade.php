    ...
    <div class="space-y-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
                ...
                <p class="text-gray-500 mt-2">Manage your account information from the owner dashboard.</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div class="lg:col-span-4">
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 h-full">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <span class="mt-4 inline-flex px-4 py-1 rounded-full bg-blue-100 text-blue-700 text-xs font-bold uppercase tracking-widest">
                    ...
                    <div class="mt-8 space-y-4">
                        ...
                        <div class="rounded-2xl bg-gray-50 border border-gray-100 p-4">
                            ...
                            <p class="text-sm font-bold text-gray-800 mt-2">Business Owner</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-8">
                <div class="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
                    ...
                    <p class="text-gray-500 mb-8">Keep your contact details current so the admin team can reach you.</p>

                    <form action="{{ route('owner.profile.update') }}" method="POST" class="space-y-8">
                        @csrf
                        @method('PUT')
