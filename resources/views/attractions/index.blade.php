        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-gray-500 mt-3">
                    Discover the beauty of Hail
                </p>
            </div>

            {{-- FILTER BAR --}}
            <form method="GET"
                  class="bg-white p-6 rounded-3xl shadow-md mb-12 grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                @forelse($attractions as $attraction)
                    ...
                    <div class="bg-white rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition border border-gray-100">
                        ...
                        <div class="h-64 overflow-hidden relative">
                            ...
                            <img src="{{ $attraction->image_url ?? 'https://via.placeholder.com/600x400' }}"
                            ...
                            @auth
                                <button
                                    ...
                                    <svg class="w-6 h-6 {{ $attraction->isFavoritedBy(auth()->user()) ? 'text-red-500' : 'text-gray-400' }}"
                                         fill="currentColor"
                                         viewBox="0 0 24 24">
